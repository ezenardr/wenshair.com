            ...
            <section className="hero-section-version1 position-relative">
                        ...
                        <div className="hero-v1-content position-relative">
                            <div className="d-flex align-items-sm-center align-items-end justify-content-between">
                                <h1 className="white-clr text-uppercase">
                                    ...
                                    <span>
                                        <span className="text-italic me-3" data-aos="zoom-in-right"
                                              data-aos-duration={2100}>
                                            Barbershop
                                        </span>
                                        <span className="designers" data-text="Premium" data-aos="zoom-in"
                                              data-aos-duration={2000}>Premium</span>
                                    </span>
                                </h1>
                                <VideoPopup style={1}/>
                            </div>
                            <div className="hero-sponsor">
                                <div
                                    className="sponsor-inner d-flex align-items-center gap-xxl-13 gap-xl-10 gap-lg-8 gap-md-6 gap-5 mb-xxl-10 mb-xl-7 mb-lg-6 mb-6">
                                    <Link href="/">
                ...
                <div className="hero-expriencebox d-flex align-items-center">
                    <div className="expri-thumb">
                        <img src="/assets/img/banner/bn-expri.jpg" alt="img"/>
                    </div>
