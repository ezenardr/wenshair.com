...
async function handleCopy(link){
    await navigator.clipboard.writeText(`https://wenshair.com/blog/${link}`)
                                    ...
                                    <div className="single-blog-post cmn-border p-xxl-7 p-xl-6 p-lg-4 p-3 mb-xxl-7 mb-xl-7 mb-lg-6 mb-5">
                                        ...
                                        <div className="post-content">
                                            ...
                                            <h5 className="white mb-xxl-8 mb-xl-7 mb-sm-6 mb-5" data-aos="fade-left" data-aos-duration={1600}>
                                                Découvrez l'Art de la Coiffure dans Notre Barbershop
                                            </h5>
                                            <p className="pra-clr mb-xxl-10 mb-xl-8 mb-sm-7 mb-6" data-aos="fade-left" data-aos-duration={1550}>
                                                Dans un monde où l’apparence joue un rôle important, une bonne coupe de cheveux n’est pas seulement une question d’esthétique, mais aussi de confiance en soi. Bienvenue dans notre barbershop, un lieu où chaque détail est pensé pour vous offrir une expérience unique et personnalisée.
                                            </p>
                                            <div className="d-flex align-items-center justify-content-between">
                                                <Link href={"/blog/art-de-la-coiffure"} className="blog-singelbtn d-center whitebg" data-aos="zoom-in" data-aos-duration={1400}>
                                                    <i className="fas fa-arrow-right" />
                                                </Link>
                                                <button onClick={()=> handleCopy('test')}  className="shapre-btn d-flex align-items-center gap-2 cmn-border py-xxl-3 py-2 px-xxl-6 px-4 pra-clr" data-aos="zoom-in-right" data-aos-duration={1600}>
                                                    Share
